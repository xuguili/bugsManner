<template>
    <section>
        <el-col :span="16" :offset="4">
            <el-form :model="addForm" label-width="100px" label-position="20" :rules="addFormRules" ref="addForm" >
                <el-form-item >
                    <h2 style="text-align: center;color: #48ace6">创建发布报告</h2>
                </el-form-item>
                <el-form-item label="邮件主题" prop="subject">
                    <el-input v-model="addForm.subject" clearable></el-input>
                </el-form-item>
                <el-form-item label="收件人" prop="recipient">
                    <el-select v-model="addForm.recipient" filterable placeholder="请选择" style="width: 40%">
                ...
                <el-form-item label="抄送人" prop="copier">
                    <el-select v-model="addForm.copier" filterable placeholder="请选择" style="width: 40%">
                        <el-option v-for="item in copier" :key="item.label" :label="item.label" :value="item.label"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="版本号" >
                    <el-input v-model="addForm.version" clearable></el-input>
                </el-form-item>
                <el-form-item label="更新内容" >
                    <el-input v-model="addForm.updateContext" clearable></el-input>
                </el-form-item>
                <el-form-item label="需求列表" style="width: 50%;float: left">
                    <el-select v-model="addForm.need" filterable  placeholder="请选择" style="width: 100%;">
                ...
                <el-form-item label="测试报告" style="width: 50%;float: left">
                    <el-input v-model="addForm.testReport"></el-input>
                </el-form-item>
                <el-form-item label="注意事项" style="margin-top: 146px" >
                    <el-input v-model="addForm.attention"></el-input>
                </el-form-item>
...
<script>
    import { addReport,getUserName } from "../../../api/api.js";
    ...
    export default {
        ...
        methods: {
            ...
            //预览邮件
            handleView(){
                this.$router.push({path:'/viewReleaseReport',query: { addForm: this.addForm }});
